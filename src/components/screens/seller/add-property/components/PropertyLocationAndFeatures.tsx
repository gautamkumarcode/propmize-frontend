...
export default function PropertyLocationAndFeatures({
  ...
  return (
    <div className="space-y-6 bg-white rounded-xl shadow p-6 border-t-4 border-purple-500">
      ...
      <h3 className="text-xl font-semibold text-gray-800 mb-4 mt-6">Property Features</h3>
      {/* Facing Dropdown */}
      {!isPlot && (
        <FormField
          control={form.control}
          ...
          render={({ field }) => (
            <FormItem>
              <FormLabel className="text-md font-semibold text-gray-700">Facing</FormLabel>
              <DropdownMenu>
                  ...
                  >
                    <span>
                      {field.value ?
                        ...
                        field.value.slice(1) : "Select Facing"}
                    </span>
      ...
      {isResidential && (
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <FormField
            ...
            render={({ field }) => (
              <FormItem>
                <FormLabel className="text-md font-semibold text-gray-700">Flooring Type</FormLabel>
                <FormControl>
                  <Input
          ...
          <FormField
            ...
            render={({ field }) => (
              <FormItem>
                <FormLabel className="text-md font-semibold text-gray-700">Water Supply</FormLabel>
                <FormControl>
                  <Input
                ...
                render={({ field }) => (
                  <FormItem>
                    <label className="flex items-center gap-2 cursor-pointer ">
                      ...
                      />
                      <span className="text-md font-semibold text-gray-700">{feat.label}</span>
                    </label>
                    <FormMessage />
                  </FormItem>
                )}
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 gap-3">
            {AMENITIES_OPTIONS.map((amenity) => (
              ...
              >
                ...
                />
                <span className="text-md font-semibold text-gray-700">{amenity}</span>
              </label>
            ))}
          </div>
